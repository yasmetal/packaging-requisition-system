...
มีตัวเลือกช่วงเวลาให้ดูย้อนหลังได้ 3 แบบ: **6 เดือนล่าสุด**, **12 เดือนล่าสุด**, และ **ทั้งหมด (ตั้งแต่เริ่มใช้งาน)** ซึ่งจะไล่ดูตั้งแต่เดือนของรายการเบิกแรกสุดในชีตจนถึงเดือนปัจจุบัน

> ⚠️ **สำคัญ:** ตัวเลือก "ทั้งหมด (ตั้งแต่เริ่มใช้งาน)" ต้องใช้โค้ด `Code.gs` เวอร์ชันล่าสุดในโปรเจกต์นี้ หากยัง deploy เวอร์ชันเก่าอยู่ ตัวเลือกนี้จะย้อนหลังได้แค่ 6 เดือนเหมือนค่าเริ่มต้นเท่านั้น (ตัวเลือก 6/12 เดือนใช้ได้อยู่แล้วไม่ต้องรอ) ให้ทำตามขั้นตอนด้านล่างเพื่ออัปเดต
