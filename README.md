...
- ทุกครั้งที่แก้โค้ดใน Apps Script (เช่นอัปเดต `Code.gs` เวอร์ชันใหม่ — รวมถึงการอัปเดตนี้ที่เพิ่มรายการถุงพลาสติก) ต้องทำ **Deploy > Manage deployments > แก้ไข (ไอคอนดินสอ) > Version: New version > Deploy** ใหม่ ไม่เช่นนั้นการเปลี่ยนแปลงจะไม่มีผล
